...
namespace Sharkbite.Irc
{
	...
	public sealed class Listener
	{
		...
		public Listener() 
		{
			...
			#else
			userPattern = new Regex( "([\\w\\-" + Rfc2812Util.Special + "]+![\\~\\w]+@[\\w\\.\\-]+)", RegexOptions.Singleline);
			channelPattern = new Regex( "([#!+&]\\w+)", RegexOptions.Singleline);
			replyRegex = new Regex("^:([^\\s]*) ([\\d]{3}) ([^\\s]*) (.*)", RegexOptions.Singleline);
			#endif
		}
